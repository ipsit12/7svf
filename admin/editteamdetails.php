                            ...
                            <div class="card-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $row['qualification'] ?>" name="qualification" class="form-control" id="heading" placeholder="Enter qualification">
                                    </div>
                                    <div class="form-group">
                                        <label for="heading">Role</label>
                                        <input type="text" value="<?php echo $row['role'] ?>" name="role" class="form-control" id="heading" placeholder="Enter job_role">
                                    </div>
                                    <div class="form-group">
...
if(isset($_POST['submit-form'])){
    ...
    if(move_uploaded_file($tmpname, $path)) {
        ...
        $sql_query = "UPDATE `team` SET `image`='$filename',`name`='$name',
        `description`='$all_descriptions',`category`='$category',`qualification`='$qualification',`role`='$role'  where id = '$id'";

        $sql_result = mysqli_query($conn, $sql_query);

        if($sql_result){
            echo "<script>alert('Data Updated successfully'); window.location.assign('./teamdetails.php');</script>";
        } else {
