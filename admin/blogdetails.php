                                    ...
                                    if(mysqli_num_rows($result) > 0) {
                                        while($row = mysqli_fetch_assoc($result)) {
                                           ...
                                           ?>
                                            ...
                                            <td><a href='editblog.php?id=<?php echo $row['id'] ?>' class='btn btn-primary'>Edit</a></td>;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="description-container">
                                            <div class="description-item">
                                                <textarea name="description[]" class="form-control description-input" id="summernote" placeholder="Enter description"></textarea>
                                            </div>
                                        </div>
...
if(isset($_POST['submit-form'])){
    ...
    if(move_uploaded_file($tmpname, $path)) {
        ...
        $sql_query = "INSERT INTO `blog`(`image`, `heading`, `description`,`category`)
                      VALUES ('$filename', '$heading', '$all_descriptions','$category')";
