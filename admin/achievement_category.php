                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                           ...
                                           <tr>
                                            <td><?php echo $row['category'] ?></td>
                                             <td><a href="delachievement_category.php?id=<?php echo $row['id'] ?>"><button class="btn btn-danger">DELETE</button></a></td> 
                                           </tr>
                                           <?php
                                        }
                                    } else {
...
if(isset($_POST['submit-form'])){
    $category = $_POST['category'];
        ...
        $sql_query = "INSERT INTO `achievement_category`(`category`)
                      VALUES ('$category')";

        $sql_result = mysqli_query($conn, $sql_query);

        if($sql_result){
            echo "<script>alert('Data inserted successfully'); window.location.assign('./achievement_category.php');</script>";
        } else {
